...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
    	try {
    		...
    		// Calls array to put pieces inside the array
//    		setPieces(pieces);			
 ...
 //   		addPiecesToBoard(chessBoard, pieces);
...
//    		    updateBoard(chessBoard, movesList, currentMove);
    		...
    		// This line not really needed, was auto generated by Eclipse
...
//Edgar's Menus------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            ImageView fileIcon = new ImageView("file:Assists/menuIcon.png");
            fileIcon.setFitHeight(20);
            fileIcon.setFitWidth(20);
            
            ImageView rulesIcon = new ImageView("file:Assists/rulesIcon.png");
            rulesIcon.setFitHeight(20);
            rulesIcon.setFitWidth(20);
            
            ImageView membersIcon = new ImageView("file:Assists/membersIcon.png");
            membersIcon.setFitHeight(20);
            membersIcon.setFitWidth(20);
            
            ImageView quitIcon = new ImageView("file:Assists/quitIcon.png");
            quitIcon.setFitHeight(20);
            quitIcon.setFitWidth(20);
            
            ImageView viewIcon = new ImageView("file:Assists/viewIcon.png");
            viewIcon.setFitHeight(20);
            viewIcon.setFitWidth(20);
            
            ImageView restartIcon = new ImageView("file:Assists/restartIcon.png");
            ...
            MenuItem gameRules = new MenuItem("Rules");
             ...
             Menu menuRestart = new Menu("Restart");
                 ...
                 menuRestart.setOnAction(new EventHandler<ActionEvent>() {
                     public void handle(ActionEvent t) {
                     	//Restart the game 
                     }
                 }); 
...
//Edgar's Menus------------------------------------------------------------------------------------------------------------------------------------------------------    
    ...
    // Adds squares to the chess board
 	...
 	private void addSquaresToBoard(GridPane chessBoard) {
 		// Makes the board have brown and lightgrey squares
